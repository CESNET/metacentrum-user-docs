...
title: PBSmon
---
**[PBSmon](https://my.metacentrum.cz/personal-view)** (shorthand from "PBS monitor") is a **web frontend** where
...
**An interactive PBS parameter selection tool** (shortly as **qsub assembler**) can be found under the  [Current state -> Qsub assembler](https://my.metacentrum.cz/qsub-assembler) tab.
