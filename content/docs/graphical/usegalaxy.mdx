...
|---------------------------|-------------------------------------------|----------------------------------------------------------------|
| **Storage**               | 250 GB (e‑infra CZ)<br/>50 GB (Life Science Login)        | Send a request to **galaxy@cesnet.cz** with a short<br/>description of your needs.      |
...
Describe your project's needs to us and we will assist with increasing your storage/compute/concurrency or other resource quotoas temporarily.
