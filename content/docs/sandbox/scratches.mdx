...
- located in `/scratch.shared/multijob-[brno|plzen]/USERNAME/`

- persistent scratch for independent consecutive jobs working on same data
- suitable for jobs working on large messes of data (databases) which take long to copy to/from storage
