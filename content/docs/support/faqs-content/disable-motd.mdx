...
After logging on some of our [frontends](../../computing/infrastructure/frontends), you are greeted by the system's Message of the Day (aka **MOTD**) with information about your last login, quotas, available CPUs, etc.

If you do not want to see this message, you can turn it off by creating empty `~/.hushlogin` file. 
