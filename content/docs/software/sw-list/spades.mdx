...
[SPAdes](https://ablab.github.io/spades/) is an assembly toolkit containing various assembly pipelines. It is intended for both standard (multicell) and single-cell MDA bacteria assemblies. 
