...
---
```bash
RStudio at OnDemand   # MetaCentrum OnDemand web app
RStudio at Kubernetes # Kubernetes web app
module avail rstudio  # module install
```
...
![pic](/img/meta/software/sw-list/rstudio-change-homedir.png)

## RStudio as a Jupyter Notebook in Kubernetes

Another option is to use [Kubernetes service](https://docs.cerit.io/en/docs/web-apps/jupyterhub#using-rstudio).

JupyterHub offers a straightforward way to launch [RStudio](https://docs.cerit.io/en/docs/rancher-apps/rstudio) directly from your Jupyter Notebook environment.
