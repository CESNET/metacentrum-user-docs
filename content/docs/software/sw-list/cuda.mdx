...
To use Cuda, you will also need to [accept the license for cuDNN library](https://signup.e-infra.cz/anyfed/registrar/?vo=meta&group=lic_cudnn). 
...
- The current version of the cuda drivers (parameter `cuda_version`) can be verified interactively in the [qsub command assembler](https://my.metacentrum.cz/qsub-assembler).
