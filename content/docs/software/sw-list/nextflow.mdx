...
---
```bash
Nextflow at Kubernetes # Kubernetes web app
...
## Nextflow in Kubernetes

Nextflow is available as a part of [Kubernetes](https://docs.cerit.io/en/docs/workflows/nextflow).

## Nextflow as a module or env
...
This page contains notes on how to use Nextflow within metaCentrum grid. However MetaCentrum modules may not contail full-blown list of Nextflow utilities. As a no. 1 choide we recommend to access [Nextflow via the Kubernetes service](https://docs.cerit.io/en/docs/workflows/nextflow).
</Callout>
