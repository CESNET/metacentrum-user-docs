...
Matlab can also be run from the JupyterHub. For detailed instructions on how to use Matlab with Jupyter Notebook, please refer [Jupyter documentation](https://docs.cerit.io/en/docs/web-apps/jupyterhub).
