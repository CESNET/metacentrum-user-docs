...
To use RepeatMasker and its submodules you first need to [accept its licence](https://signup.e-infra.cz/allfed/registrar/?vo=meta&group=lic_repeatmasker) with the following license terms:
