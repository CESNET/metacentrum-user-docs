...
Newer versions of TensorFlow are **available solely as [Singularity images](./containers#singularity-usage)** optimized for usage with NVidia GPUs (NVidia GPU Cloud, NGC).
