...
<Callout type="info"> 
In order to access the VASP software installed in MetaCenter, users are required to register all group users through the official [VASP License Management Portal](https://www.vasp.at/sign_in/portal/). 
</Callout>
