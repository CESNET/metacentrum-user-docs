...
- [How to search for specific software](./search-soft): systematic guide to how to search through modules,
- [Graphical access](./graphical-access): various ways how to work with software with GUI,
- [Modules](./modules): how to load and use modules in MetaCentrum,
- [Containers](./containers): how to use Docker and Apptainer containers in MetaCentrum,
- [How to install software locally](./install-software): a guide to user-side software installation.
