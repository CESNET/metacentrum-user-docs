...
|------------|-------------|
| [elixircz@pbs-m1.metacentrum.cz](https://metavo.metacentrum.cz/pbsmon2/queue/elixircz@pbs-m1.metacentrum.cz) | Queue using hardware dedicated to [ELIXIR](../../access/elixir) group members |
...
| [gpu\_dgx@pbs-m1.metacentrum.cz](https://metavo.metacentrum.cz/pbsmon2/queue/gpu_dgx@pbs-m1.metacentrum.cz)   | [Jobs requiring >= 4 GPUS with NVlink](../gpu-comput/dgx) |
