...
| [large\_mem@pbs-m1.metacentrum.cz](https://my.metacentrum.cz/queues/large_mem@pbs-m1.metacentrum.cz) | Jobs requiring 500 GB or more, up to 1 week walltime |
| [gpu\_dgx@pbs-m1.metacentrum.cz](https://my.metacentrum.cz/queues/gpu_dgx@pbs-m1.metacentrum.cz)   | [Jobs requiring >= 4 GPUS with NVlink](../gpu-comput/dgx) |
