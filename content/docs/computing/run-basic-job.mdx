...
<Callout type="info" title="To start, you need to">
...
![pic](/img/meta/computing/batch-job-scheme_border.jpg)
...
![pic](/img/meta/computing/interact-job-scheme_border.jpg)
...
<Callout type="info" title="Exit status is meaningful only for batch jobs">
...
<Callout type="info" title="For older jobs, use pbs-get-job-history">
...
![pic](/img/meta/computing/exit_status.png)
...
![pic](/img/meta/computing/sigterm.png)
