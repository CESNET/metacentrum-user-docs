...
- Versions of NGC images requiring CUDA version higher than 11.0 are not supported (see https://my.metacentrum.cz/machines and search for Resource -> cuda\_version)
