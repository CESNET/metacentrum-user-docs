...
| [Shared](#shared-scratch) | `scratch_shared` | slow |  |
| [Shared scratch on Bee cluster](#shared-scratch-on-cluster-bee) |  `scratch_shared` AND `cl_bee=True` | fast | no | will be discontinued |
...
<Callout type="info" title="Will be discontinued soon">
