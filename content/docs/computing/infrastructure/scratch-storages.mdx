...
| [Shared](#shared-scratch) | `scratch_shared` | slow | no |
| [Shared scratch on Bee cluster](#shared-scratch-on-cluster-bee) |  `scratch_shared` AND `cl_bee=True` | fast | yes | will be discontinued |
...
<Callout type="info" title="Will be discontinued soon">
    This type of scratch will be discontinued by September/October 2026.
</Callout>
