...
| [Shared scratch on Bee cluster](#shared-scratch-on-cluster-bee) |  `scratch_shared` AND `cl_bee=True` | fast | yes | data will be moved to `/scratch/multijob-brno` |
| [Multijob fast](#multijob-scratch-fast) | `multijob` | fast | yes | manual, `/scratch/multijob-[brno/plzen]` |
| [Multijob global](#multijob-scratch-global) | `multijob` | slow | yes | manual, `scratch-global` |
