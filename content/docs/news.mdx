...
We would like to inform about a significant update to our computing job management and monitoring tools. The existing monitoring application, PBSmon, has been replaced by a modern web application, my.MetaCentrum, available at my.metacentrum.cz.
