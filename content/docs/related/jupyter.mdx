...
This is tutorial for **[Metacentrum instance of Jupyter notebook](https://jupyter.metacentrum.cz)** servers on cloud.
...
Login into [https://jupyter.metacentrum.cz](https://jupyter.metacentrum.cz) (ensure it loads `/storage/brno2/"$USER"/.jupyter_bashrc`) and in menu **New** in top-right should be new option **R**. Select and enjoy. :-)
