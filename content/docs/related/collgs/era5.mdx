...
As of **January 14, 2026** following data are available at MetaCenter premises:

- Reanalysis ERA5-Land: March 1990 - January 2026
- Reanalysis ERA5 on single levels: May 2007 - January 2026
- Reanalysis ERA5 on pressure levels: May 2002 - January 2026

Newer as well as older data is still being downloaded and processed back to the earliest available month of each respective dataset.
...
```
/collections/<dataset-name>/items/<dataset-name>_<YYYYMMDD>_<area-name>
```

...where `area-name` is for Czech Republic == `czech-republic`

NetCDF format is as of today considered **experimental** by ECMWF and thus it is not being currently downloaded!
