...
A more complex tutorial for several use cases was prepared for the CSCALE project. You can follow the tutorial at [C-SCALE Data Discovery Notebook](./c-scale-notebooks/datadiscovery).
